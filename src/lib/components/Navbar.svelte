...
<svelte:window
    onscroll={() => showScrollTop = window.scrollY > 100}
/>
...
{#snippet arrowUpSvg()}
    <svg class={`h-[20px] aspect-square fill-none group-hover:stroke-[3] stroke-neutral-800 dark:group-hover:stroke-[2.5] stroke-2 dark:group-hover:stroke-neutral-50 dark:stroke-neutral-400 transition-all duration-300 lucide lucide-arrow-up-icon lucide-arrow-up`} viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
